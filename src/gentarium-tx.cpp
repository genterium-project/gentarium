...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Gentarium Core gentarium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gentarium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gentarium transaction") + "\n" +
              "  gentarium-tx [options] -create [commands]   " + _("Create hex-encoded gentarium transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gentarium transaction
