    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextGentarium   = QChar(0xA9)+QString(" 2014-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Dash Core, Gentarium developers"));
    ...
    pixPaint.setPen(QColor(248,248,248));
