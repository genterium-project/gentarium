    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Gentarium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gentarium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gentarium: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Gentarium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gentarium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gentarium Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gentarium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gentarium addresses"));
    ...
    openAction->setStatusTip(tr("Open a gentarium: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gentarium Core help message to get a list with possible Gentarium Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Gentarium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gentarium network", "", count));
    } else {
...
{
    QString strTitle = tr("Gentarium Core"); // default title
    ...
    // Append title to "Gentarium Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
