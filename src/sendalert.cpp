...
2. run gentariumd with -printalert or -sendalert like this:
   /path/to/gentariumd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.gentarium.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Gentarium Core:0.12.0.58/"));
