...
Gentarium Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Gentarium Core, where everyone uses
...
pay attention to for reviewers of Gentarium Core code.

General Gentarium Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Gentarium Core uses tinyformat, which is type safe. Leave them out to avoid confusion
