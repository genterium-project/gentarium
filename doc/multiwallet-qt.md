...
Only requiring some minor changes is gentarium.cpp.
...
Changes to gentarium.cpp
----------------------
gentarium.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
